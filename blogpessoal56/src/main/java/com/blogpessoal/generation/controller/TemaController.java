package com.blogpessoal.generation.controller;
...
import com.blogpessoal.generation.model.Tema;
import com.blogpessoal.generation.repository.TemaRepository;
...
public class TemaController {
	  ...
	  @Autowired
	    ...
	    public ResponseEntity<List<Tema>> getByDescricao(@PathVariable String tema){
	    	return (ResponseEntity<List<Tema>>) ResponseEntity.ok(temaRepository.findAllByTemaContainingIgnoreCase(tema));
